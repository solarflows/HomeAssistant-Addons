...
2026-01-20 Lucky v2.26.2
    1.Docker管理
        1.1容器列表在不按项目显示的时候支持自定义排序和分组管理
        1.2 增加镜像上传进度显示
        1.3 修复镜像导出损坏问题
        1.4 优化 Compose 配置文件名的识别
    2.ACME：新增 HTTPS 验证方式
    3.Filebrowser 升级至 v2.55.0
    4.frp 支持访问者（Visitor）配置
    5.DDNS： 修复Namesilo 接口变动导致的域名记录重复问题
    6.其他细节优化
